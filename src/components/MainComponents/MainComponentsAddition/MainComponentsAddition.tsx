...
const MainComponentsAddition: React.FC = () => {
    ...
    // Создание массива из всех изображений
    const allImages = [...images, ...firstSetImages, ...secondSetImages, ...thirdSetImages]

    // Используйте полученные значения и изображения по вашему усмотрению
							...
							<div className='MainComAddPhotoSecond'>
								<div className='addPhotoFirst'>
									{firstSetImages.length > 0 ? (
										...
										<div className='file-input-container1'>
											<label htmlFor='fileInput1' className='file-input-label1'>
								...
								<div className='addPhotoFirst'>
									{secondSetImages.length > 0 ? (
										...
										<div className='file-input-container1'>
											<label htmlFor='fileInput2' className='file-input-label1'>
												<span style={{ color: 'white' }}>+</span>
											</label>
											<input
												type='file'
								...
								<div className='addPhotoFirst'>
									{thirdSetImages.length > 0 ? (
										...
										<div className='file-input-container1'>
											<label htmlFor='fileInput3' className='file-input-label1'>
												<span style={{ color: 'white' }}>+</span>
											</label>
											<input
												type='file'
